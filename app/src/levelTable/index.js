...
const LevelTable = () => {
    ...
    return(<div className="table" id="table">
    <text className="row" id="row" onClick={oculta}>→</text>
    <h1 className="dificuldade" id="dificult">DIFICULDADE</h1>
    <button className="fácil" id="facil" onClick={destaca1}>FÁCIL</button>
    <button className="médio" id="medio" onClick={destaca2}>MÉDIO</button>
    <button className="difícil" id="dificil" onClick={destaca3}>DIFÍCIL</button>
    <h1 className="modo" id="butmod">MODO DE JOGO</h1>
    <button className="modo" id="modo" onClick={muda_modo}>JOGO NORMAL</button>
</div>)
}
